...
const ACCIONES: Entrada[] = [
  { clave: 'add-producto', titulo: 'Añadir producto al inventario', categoria: 'Hacer ahora', ruta: '/app/inventario?hacer=producto', icono: Boxes,
    palabras: ['añadir', 'agregar', 'nuevo', 'alta', 'meter', 'dar de alta', 'ingrediente', 'genero', 'despensa'] },
  { clave: 'quitar-producto', titulo: 'Corregir lo que hay en cámara', categoria: 'Hacer ahora', ruta: '/app/inventario', icono: Boxes,
    palabras: ['quitar', 'restar', 'sacar', 'descontar', 'corregir', 'ajustar', 'stock', 'despensa'] },
  { clave: 'add-proveedor', titulo: 'Añadir proveedor', categoria: 'Hacer ahora', ruta: '/app/inventario?tab=proveedores&hacer=proveedor', icono: Boxes,
    palabras: ['añadir', 'nuevo', 'proveedor', 'distribuidor', 'alta'] },
  { clave: 'pedido', titulo: 'Crear un pedido', categoria: 'Hacer ahora', ruta: '/app/inventario?tab=pedidos&hacer=pedido', icono: Boxes,
    palabras: ['pedir', 'comprar', 'pedido', 'encargo', 'añadir'] },
  { clave: 'merma', titulo: 'Registrar una merma', categoria: 'Hacer ahora', ruta: '/app/servicio?tab=mermas&hacer=merma', icono: ClipboardCheck,
    palabras: ['tirar', 'perdida', 'roto', 'caducado', 'merma', 'registrar', 'añadir'] },
  { clave: 'temperatura', titulo: 'Registrar temperatura (APPCC)', categoria: 'Hacer ahora', ruta: '/app/servicio?tab=appcc', icono: ClipboardCheck,
    palabras: ['temperatura', 'camara', 'appcc', 'sanidad', 'control', 'registrar', 'añadir', 'nevera'] },
  { clave: 'cerrar', titulo: 'Cerrar la caja del día', categoria: 'Hacer ahora', ruta: '/app/servicio?hacer=cierre', icono: ClipboardCheck,
    palabras: ['cerrar', 'caja', 'cierre', 'z', 'arqueo'] },
  { clave: 'ficha', titulo: 'Crear una ficha técnica', categoria: 'Hacer ahora', ruta: '/app/cocina?hacer=ficha', icono: ChefHat,
    palabras: ['añadir', 'nueva', 'receta', 'ficha', 'plato', 'escandallo'] },
  { clave: 'carta', titulo: 'Montar la carta', categoria: 'Hacer ahora', ruta: '/app/cocina?tab=carta', icono: ChefHat,
